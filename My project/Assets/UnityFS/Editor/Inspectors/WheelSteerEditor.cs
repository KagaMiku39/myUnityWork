...
[CustomEditor(typeof(WheelSteer))]
public class WheelSteerEditor : InputEditor
{
    ...
    SerializedProperty steerModel;
    SerializedProperty steerRotationAxis;
    SerializedProperty steerMaxAngle;
    ...
    private void OnEnable()
    {
        ...
        steerModel = serializedObject.FindProperty("steerModel");
        steerRotationAxis = serializedObject.FindProperty("steerRotationAxis");

        steerMaxAngle = serializedObject.FindProperty("steerMaxAngle");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (m_InputFoldOut == true)
        {
            ...
            ShowInputAxisOptions("Steer", Controller);
        ...
        EditorGUILayout.Space();
        EditorGUILayout.PropertyField(steerModel, new GUIContent("Steer Model"));
        EditorGUILayout.PropertyField(steerRotationAxis, new GUIContent("Steer Rotation Axis"));
        EditorGUILayout.PropertyField(steerMaxAngle, new GUIContent("Steer Max Angle"));
